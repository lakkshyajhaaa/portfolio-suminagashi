...
export default function Work() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-8 md:p-24 bg-transparent">
      ...
      <div className="absolute top-[80px] left-6 md:top-24 md:left-32 flex flex-col pointer-events-auto z-10 animate-fade-in">
        ...
        <h1 className="font-sans text-[3.5rem] md:text-[6rem] tracking-[-0.05em] font-bold text-white leading-[0.8] mt-4 drop-shadow-[0_0_15px_rgba(255,255,255,0.4)] mix-blend-difference">
          INDEX.
        </h1>
      </div>
