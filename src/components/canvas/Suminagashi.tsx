...
void main() {
  ...
  vec3 finalColor = baseColor + (shineColor * specular * 2.0);
...
const routeConfigs: Record<string, { c1: string, c2: string, c3: string, c4: string, line: string, behavior: number }> = {
  ...
  // About (Ancient Library): Aged parchment, deep emerald, brass, dark leather
  "/about": { c1: "#fef3c7", c2: "#064e3b", c3: "#92400e", c4: "#451a03", line: "#14532d", behavior: 2.0 }, 
